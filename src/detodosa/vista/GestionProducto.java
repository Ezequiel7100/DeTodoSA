...
private Producto auxiliar;
    ...
    private void initComponents() {
        ...
        jbGuardar.setBackground(new java.awt.Color(51, 255, 51));
        ...
        jbBuscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/detodosa/imagenes/iconoBuscar.png"))); // NOI18N
    ...
    private void jbEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEliminarActionPerformed
       int resp=JOptionPane.showConfirmDialog(this, "¿Desea eliminar "+auxiliar.getDescripcion()+"?",
    ...
    private void jbSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSalirActionPerformed
        ...
        dispose();//sirve para cerrar la pestalla
    ...
    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
        ...
        try{
            ...
            jtCodigo.setText("");//resetea el texto
            jtCodigo.requestFocus();//envia al usuario donde cometio el error 
            return;
        }
